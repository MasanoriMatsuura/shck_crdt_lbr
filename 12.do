...
save yield12.dta, replace

**Agricultural practices
use $base\q4_2_3.dta, clear
tab co6
tab co6, nolabel // Aus
recode co6 (1 101/330=1 "Rice")(2=2 "Betel leaf")(3=3 "Fruits")(4=4 "Wheat")(5=5 "Sugarcane")(6=6 "Potato")(7=7 "Pulse")(8=8 "Vegetables")(9=9 "Tobacco")(10=10 "Oil seeds")(11=11 "Onion/Garlic")(12=12 "Spices")(13=13 "Jute")(14=14 "Maize")(nonm=15 "Others"), gen(crp_aus)
...
drop haus2 haman2 hboro2 sdaus2 sdaman2 sdboro2 //sum_aus2_dummy sum_aman2_dummy sum_boro2_dummy 

foreach v of varlist haus1 haman1 hboro1 sdaus1 sdaman1 sdboro1 adm3_pcode adm2_pcode {
	replace `v'="0" if `v'=="NA"
} //aus1 aman1 boro1
destring nid lon lat haus1 haman1 hboro1 sdaus1 sdaman1 sdboro1 adm3_pcode adm2_pcode id ,replace //sum_aus1_dummy sum_aman1_dummy sum_boro1_dummy, replace //aus1 aman1 boro1
...
rename (haus1 haman1 hboro1 sdaus1 sdaman1 sdboro1 )(haus haman hboro sdaus sdaman sdboro ) //sum_aman1_dummy sum_boro1_dummy heataman heatboro
...
drop sd2 ave2 sd2_10yr ave2_10yr sd2_20yr ave2_20yr temp_sd2 temp_ave2 temp_sd2_10yr temp_ave2_10yr temp_sd2_20yr temp_ave2_20yr
capture drop rain_survey_ave2
capture rename rain_survey_ave1 rain_survey_ave
capture label var rain_survey_ave "Survey year rainfall"

foreach v of varlist sd1 ave1 sd1_10yr ave1_10yr sd1_20yr ave1_20yr adm3_pcode adm2_pcode rain_survey_ave {
	capture confirm string variable `v'
	if !_rc {
		replace `v'="0" if `v'=="NA"
	}
}
destring nid lon lat sd1 ave1 sd1_10yr ave1_10yr sd1_20yr ave1_20yr adm3_pcode adm2_pcode id rain_survey_ave, replace

gen cov_year = (ave1/sd1)
gen cov_year_10yr = (ave1_10yr/sd1_10yr)
gen cov_year_20yr = (ave1_20yr/sd1_20yr)

gen temp_cov_year = (temp_ave1/temp_sd1)
gen temp_cov_year_10yr = (temp_ave1_10yr/temp_sd1_10yr)
gen temp_cov_year_20yr = (temp_ave1_20yr/temp_sd1_20yr)
...
merge 1:1 idno using yield12.dta, nogen
merge 1:1 idno using crop12.dta, nogen
merge 1:1 idno using input12.dta, nogen
merge m:1 upzi using climate12, nogen
merge m:1 upzi using climate_year12, nogen
foreach var in crdt_bnk crdt_ng crdt_inf crdt_amt_bnk crdt_amt_ng crdt_amt_inf bcp_uptake bcp_amt crdt_accss chld_w chld_w_f chld_w_n edu_exp d_rice_aus d_jute_aus d_rice_aman d_rice_robi d_rice_boro d_hyv_aus d_hyv_aman d_hyv_robi d_hyv_boro d_hyv exp_fertilizer d_fertilizer exp_pesticide d_pesticide {
